                ...
                <div class="mt-10 flex flex-wrap justify-center gap-3">
                    <div class="relative group">
                        <div class="absolute opacity-0 duration-300 group-hover:opacity-100 bg-[#00000077] w-full h-full flex justify-center text-white items-center font-medium flex-col gap-10">
                            <div class="text-2xl sm:text-5xl">HORTAIN PLACE</div>
                            <div class="px-10 sm:text-md text-xs text-wrap">Explore the misty grasslands, stunning cliffs, and the breathtaking World's End at Horton Plains National Park</div>
                        </div>
                    ...
                    <div class="relative group">
                        <div class="absolute opacity-0 duration-300 group-hover:opacity-100 bg-[#00000077] w-full h-full flex justify-center text-white items-center font-medium flex-col gap-10">
                            <div class="text-2xl sm:text-5xl">HORTAIN PLACE</div>
                            <div class="px-10 text-wrap sm:text-md text-xs">Explore the misty grasslands, stunning cliffs, and the breathtaking World's End at Horton Plains National Park</div>
                        </div>
