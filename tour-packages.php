        ...
        <div class="max-w-[2500px] w-full bg-slate-300 grow text-white">
            ...
            <div class="py-20 w-full px-5 sm:px-10 flex flex-col bg-white text-black items-center justify-center gap-5">
                <div class="w-full justify-center flex gap-5 text-xs sm:text-md">
                    <a href="tour-packages.php" class="bg-[#FF9933] text-white py-2 px-8 rounded-full font-bold duration-300 text-center">TRAILOR MADE TOURS</a>
                    <span class="w-1 h-auto bg-black "></span>
                    <a href="round-tour-packages.php" class="hover:bg-[#FF9933] hover:text-white py-2 px-8 rounded-full font-bold duration-300 text-center">ROUND TOURS</a>
                </div>
                ...
                <div class="flex justify-center gap-5  flex-wrap">
                    ...
                    <div class="sm:w-[578px] sm:h-[736px] h-[500px] bg-slate-300 flex flex-col justify-end relative group" style="background-image: url(Assets/img\(7\).png);">
                        ...
                        <div class="p-10 font-[600] w-full text-white z-10 group-hover:bg-[#ff9933] duration-300">
                            ...
                            <div><span class="text-xl sm:text-3xl">PRICE $100/ </span> <span class="text-xs sm:text-md">5DAYS TRIPS</span></div>
                        </div>
                    </div>
                    </div>
                    <div class="">
            ...
            <div class="w-full bg-white text-black">
                <div class="w-full flex pt-10 px-5 sm:px-0 sm:pt-28 pb-10 flex-col justify-center items-center gap-5">
                    ...
                    <div class="sm:w-3/7 flex justify-center sm:text-center font-pri ">A tailor-made tour gives you the freedom to travel on your terms. Whether you prefer a relaxed itinerary or an action-packed adventure, we design a journey that suits your interests, pace, and budget. With handpicked accommodations, personalized experiences, and expert local guides, you get a seamless and hassle-free travel experience. From hidden gems to iconic landmarks, explore Sri Lanka exactly the way you want, with the flexibility to adjust your plans along the way.</div>
                </div>

                <div class="w-full flex flex-wrap px-5 sm:px-20 pb-20">
                    <div class="sm:w-1/3 w-full flex gap-10 sm:px-10 py-10 sm:py-20">
                        <img class=" sm:w-auto" src="Assets/Group 23364.png" alt="">
